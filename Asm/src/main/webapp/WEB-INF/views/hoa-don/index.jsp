...
<div class="container">
    ...
    <table class="table table-sm">
        ...
        <tbody>
        <c:forEach items="${listHoaDon.content}" var="hoaDon" varStatus="stt">
            <tr>
                <td>${stt.index + 1}</td>
    ...
    <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item"><a class="page-link" href="/hoa-don/hien-thi?page=0">First</a></li>
                <li class="page-item"><a class="page-link"
                                         href="/hoa-don/hien-thi?page=${listHoaDon.number-1}">Previous</a></li>
                <c:forEach begin="0" end="${listHoaDon.totalPages - 1}" varStatus="index">
                    <li class="page-item"><a class="page-link"
                                             href="/hoa-don/hien-thi?page=${index.begin + index.count-1}">
                            ${index.begin + index.count}
                    </a></li>
                </c:forEach>
                <li class="page-item"><a class="page-link" href="/hoa-don/hien-thi?page=${listHoaDon.number+1}">Next</a>
                </li>
                <li class="page-item"><a class="page-link"
                                         href="/hoa-don/hien-thi?page=${listHoaDon.totalPages-1}">Last</a></li>
            </ul>
        </nav>
    </div>
</div>
